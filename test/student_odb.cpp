...
namespace odb
{
  ...
  struct access::object_traits_impl< ::student, id_oracle >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::student, id_oracle >::id_type
  access::object_traits_impl< ::student, id_oracle >::
  ...
  void access::object_traits_impl< ::student, id_oracle >::
  bind (oracle::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::student, id_oracle >::persist_statement[] =
  "INSERT INTO \"student\" "
  "(\"ID\", "
  "\"NAME\") "
  "VALUES "
  "(\"student_SEQ\".nextval, :1) "
  "RETURNING \"ID\" INTO :2";

  const char access::object_traits_impl< ::student, id_oracle >::find_statement[] =
  "SELECT "
  "\"student\".\"ID\", "
  "\"student\".\"NAME\" "
  "FROM \"student\" "
  ...
  const char access::object_traits_impl< ::student, id_oracle >::update_statement[] =
  "UPDATE \"student\" "
  "SET "
  "\"NAME\"=:1 "
  "WHERE \"ID\"=:2";

  const char access::object_traits_impl< ::student, id_oracle >::erase_statement[] =
  "DELETE FROM \"student\" "
  "WHERE \"ID\"=:1";

  const char access::object_traits_impl< ::student, id_oracle >::query_statement[] =
  "SELECT "
  "\"student\".\"ID\", "
  "\"student\".\"NAME\" "
  "FROM \"student\"";

  const char access::object_traits_impl< ::student, id_oracle >::erase_query_statement[] =
  "DELETE FROM \"student\"";

  const char access::object_traits_impl< ::student, id_oracle >::table_name[] =
  "\"student\"";
  ...
  access::object_traits_impl< ::student, id_oracle >::pointer_type
  access::object_traits_impl< ::student, id_oracle >::
  ...
  bool access::object_traits_impl< ::student, id_oracle >::
  ...
  result< access::object_traits_impl< ::student, id_oracle >::object_type >
  access::object_traits_impl< ::student, id_oracle >::
  ...
  unsigned long long access::object_traits_impl< ::student, id_oracle >::
